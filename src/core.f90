...
module syntran__core_m
	...
	!  - literals
	!    * octal "0o", binary "0b"
	!    * add general suffix option, e.g. 1'i32, 2'i64, 2.3'f32, ... to allow
	...
	!      cause problems? not if we use a delimiter like "'" between the body
	!      of the literal and its suffix: 42'i32
	!  - f64
