...
subroutine modulo_value_t(left, right, res, op_text)
	...
	case        (magic**2 * array_type + magic * array_type + f32_type)
		...
		case (f64_type)
			res%array = mold(left%array, f32_type)
			res%array%f32 = mod(real(left%array%f64), right%sca%f32)
		case (i32_type)
			res%array = mold(left%array, f32_type)
	...
	case        (magic**2 * array_type + magic * array_type + f64_type)
		...
		case (f32_type)
			...
			res%array%f64 = mod(real(left%array%f32, 8), right%sca%f64)
		case (f64_type)
			res%array = mold(left%array, f64_type)
	...
	case        (magic**2 * array_type + magic * f32_type + array_type)
		...
		case (f64_type)
			res%array = mold(right%array, f32_type)
			res%array%f32 = mod(left%sca%f32, real(right%array%f64))
		case (i32_type)
			res%array = mold(right%array, f32_type)
	...
	case        (magic**2 * array_type + magic * f64_type + array_type)
		...
		case (f32_type)
			res%array = mold(right%array, f64_type)
			res%array%f64 = mod(left%sca%f64, real(right%array%f32, 8))
		case (f64_type)
			res%array = mold(right%array, f64_type)
	...
	case        (magic**2 * array_type + magic * array_type + array_type)
		...
		case (magic * f32_type + f64_type)
			res%array = mold(right%array, f64_type)
			res%array%f64 = mod(real(left%array%f32, 8), right%array%f64)

		case (magic * f64_type + f32_type)
			res%array = mold(right%array, f64_type)
			res%array%f64 = mod(left%array%f64, real(right%array%f32, 8))
	...
	case        (magic**2 * i32_type + magic * i32_type + i64_type)
		res%sca%i32 = mod(left%sca%i32, int(right%sca%i64))
	...
	case        (magic**2 * f32_type + magic * f32_type + f64_type)
		res%sca%f32 = mod(left%sca%f32, real(right%sca%f64))

	case        (magic**2 * f64_type + magic * f32_type + f64_type)
		res%sca%f64 = mod(real(left%sca%f32, 8), right%sca%f64)

	case        (magic**2 * f64_type + magic * f64_type + f32_type)
		res%sca%f64 = mod(left%sca%f64, real(right%sca%f32, 8))
